...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->rowCount() > 0) {
        ...
        $expiry = date("Y-m-d H:i:s", time() + 60 * 600);
        ...
        try {
            ...
            $reset_link = "localhost/webprog-lecture/lec/auth/reset-password.php?token=" . $reset_token;        
            $mail->Body = <<<END
...
<head>
    ...
    <title>Forgot Password - Ticketbox</title>
    ...
    <div class="container wrapper">
        <div class="main-container">
            ...
            <form method="POST" action="">
                ...
                <button type="submit" class="btn btn-primary btn-custom">Send Reset Link</button>
            </form>
